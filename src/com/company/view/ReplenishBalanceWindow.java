...
public class ReplenishBalanceWindow {
    static JFrame frame = createFrame();
    private boolean save;

    public ReplenishBalanceWindow() {
        save = false;


        JLabel label = new JLabel("Пополнение баланса");
        JLabel lbl1 = new JLabel("Имя:");
        JLabel lbl2 = new JLabel("Баланс:");
        JLabel lbl3 = new JLabel("Номер карты:");
        JLabel lbl4 = new JLabel("ФИ владельца:");
        JLabel lbl5 = new JLabel("CVV карты:");
