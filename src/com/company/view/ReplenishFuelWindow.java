...
public class ReplenishFuelWindow {
    static JFrame frame = createFrame();
    private boolean save;

    public ReplenishFuelWindow() {
        save = false;


        JLabel label = new JLabel("Пополнение топлива");
        JLabel lbl1 = new JLabel("Имя:");

        JLabel lbl3 = new JLabel("Название топлива:");
        JLabel lbl4 = new JLabel("Цена топлива:");
        JLabel lbl5 = new JLabel("Колиество:");
